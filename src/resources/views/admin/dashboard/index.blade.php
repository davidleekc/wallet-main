@extends('admin.modal')
@section('content')
  <div class="page-body" onmousemove="myFunction(event)" onmouseout="clearCoor()">
              ...
              <div class="row m-0">
                <div class="col-xl-3 earning-content p-0">
                  <div class="row m-0 chart-left">
                    ...
                    <div class="col-xl-12 p-0 left_side_earning">
                      <h5 id="demo">Not detected</h5>
                      <p class="font-roboto">Your mouse location</p>
            ...
            <div class="card-header card-no-border">
              ...
              <div class="media">
                <div class="media-body">
                  ...
                  <div class="card-body">
                    <div class="owl-carousel owl-theme" id="owl-carousel-1" style="max-width:352.656px;">
...
function clearCoor() {
  document.getElementById("demo").innerHTML = "Not detected";
}
  </script>
@endsection