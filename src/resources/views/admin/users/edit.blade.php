            ...
            <div class="container">
                <div class="justify-content-center">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            {!! Form::model($user, ['route' => ['users.update', $user->id], 'class' => 'form theme-form' , 'method'=>'PATCH']) !!}
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="mb-3">
                                            ...
                                            {!! Form::select('roles[]', $roles, $userRole, array('class' => 'form-control input-air-primary','multiple')) !!}
                                        </div>
                                    </div>
                                </div>
