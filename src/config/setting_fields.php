    ...
    'app' => [
        ...
        'elements' => [
            [
                ...
                'value' => 'LARAVEL EWALLET', // default value if you want
            ],
            [
                'type'  => 'text', // input fields type
                'data'  => 'string', // data type, string, int, boolean
                ...
                'class' => '', // any class for input
                'value' => '<a href="https://github.com/davidleekc/e-wallet-laravel-admin">Built By David</a>', // default value if you want
            ],
            [
    ...
    'meta' => [
        ...
        'elements' => [
            [
                ...
                'class' => '', // any class for input
                'value' => 'Awesome Ewallet | An Ewallet Dashboard Project', // default value if you want
            ],
            [
                'type'  => 'text', // input fields type
                'data'  => 'text', // data type, string, int, boolean
                ...
                'rules' => 'required', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'An E-Wallet admin dashboard application project built with Laravel.', // default value if you want
            ],
            [
                'type'  => 'text', // input fields type
                'data'  => 'text', // data type, string, int, boolean
                ...
                'rules' => 'required', // validation rule of laravel
                'class' => '', // any class for input
                'value' => 'Web Application, Laravel, Bootstrap, Admin, E-wallet, Dashboard', // default value if you want
            ],
            [
                'type'  => 'text', // input fields type
                'data'  => 'text', // data type, string, int, boolean
