...
*
* New Routes
* These routes need New permission
* --------------------------------------------------------------------
*/

Route::group(['namespace' => 'Admin', 'middleware' => ['auth']], function () {
    Route::get('/cuba/dashboard', [App\Http\Controllers\Admin\DashboardController::class, 'index'])->name('dashboard');
    Route::resource('/cuba/users', AdminUserController::class);
    Route::resource('/cuba/clients', AdminClientController::class);
});
